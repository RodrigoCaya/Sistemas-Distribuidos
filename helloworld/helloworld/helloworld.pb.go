...
type Message struct {
	...
	Propietario string `protobuf:"bytes,6,opt,name=propietario,proto3" json:"propietario,omitempty"`
}
...
func (x *Message) GetPropietario() string {
	if x != nil {
		return x.Propietario
	}
	return ""
}
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0x9f, 0x01, 0x0a, 0x07, 0x4d, 0x65,
	...
	,
}
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	1, // 1: helloworld.RespuestaService.SayAnswer:input_type -> helloworld.Respuesta
	0, // 2: helloworld.HelloworldService.SayHello:output_type -> helloworld.Message
	1, // 3: helloworld.RespuestaService.SayAnswer:output_type -> helloworld.Respuesta
...
// RespuestaServiceClient is the client API for RespuestaService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type RespuestaServiceClient interface {
	SayAnswer(ctx context.Context, in *Respuesta, opts ...grpc.CallOption) (*Respuesta, error)
}

type respuestaServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewRespuestaServiceClient(cc grpc.ClientConnInterface) RespuestaServiceClient {
	return &respuestaServiceClient{cc}
}

func (c *respuestaServiceClient) SayAnswer(ctx context.Context, in *Respuesta, opts ...grpc.CallOption) (*Respuesta, error) {
	out := new(Respuesta)
	err := c.cc.Invoke(ctx, "/helloworld.RespuestaService/SayAnswer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RespuestaServiceServer is the server API for RespuestaService service.
type RespuestaServiceServer interface {
	SayAnswer(context.Context, *Respuesta) (*Respuesta, error)
}

// UnimplementedRespuestaServiceServer can be embedded to have forward compatible implementations.
type UnimplementedRespuestaServiceServer struct {
}

func (*UnimplementedRespuestaServiceServer) SayAnswer(context.Context, *Respuesta) (*Respuesta, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayAnswer not implemented")
}

func RegisterRespuestaServiceServer(s *grpc.Server, srv RespuestaServiceServer) {
	s.RegisterService(&_RespuestaService_serviceDesc, srv)
}

func _RespuestaService_SayAnswer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Respuesta)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RespuestaServiceServer).SayAnswer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.RespuestaService/SayAnswer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RespuestaServiceServer).SayAnswer(ctx, req.(*Respuesta))
	}
	return interceptor(ctx, in, info, handler)
}

var _RespuestaService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.RespuestaService",
	HandlerType: (*RespuestaServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayAnswer",
			Handler:    _RespuestaService_SayAnswer_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "helloworld/helloworld.proto",
