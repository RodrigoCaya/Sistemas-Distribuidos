...
type PaqueteRequest struct {
	...
	Tiempo      string `protobuf:"bytes,11,opt,name=tiempo,proto3" json:"tiempo,omitempty"`
}
...
func (x *PaqueteRequest) GetTiempo() string {
	if x != nil {
		return x.Tiempo
	}
	return ""
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xb0, 0x02, 0x0a, 0x0e, 0x50, 0x61, 0x71,
	...
	0x69, 0x6e, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x69, 0x65, 0x6d, 0x70, 0x6f, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x69, 0x65, 0x6d, 0x70, 0x6f, 0x32, 0x9a, 0x02, 0x0a, 0x11,
	...
	,
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	2, // 3: helloworld.HelloworldService.EnviarDatos:input_type -> helloworld.PaqueteRequest
	0, // 4: helloworld.HelloworldService.SayHello:output_type -> helloworld.Message
	1, // 5: helloworld.HelloworldService.Buscar:output_type -> helloworld.CodeRequest
	2, // 6: helloworld.HelloworldService.EnviarPaquete:output_type -> helloworld.PaqueteRequest
	1, // 7: helloworld.HelloworldService.EnviarDatos:output_type -> helloworld.CodeRequest
...
type HelloworldServiceClient interface {
	...
	EnviarDatos(ctx context.Context, in *PaqueteRequest, opts ...grpc.CallOption) (*CodeRequest, error)
}
...
func (c *helloworldServiceClient) EnviarDatos(ctx context.Context, in *PaqueteRequest, opts ...grpc.CallOption) (*CodeRequest, error) {
	out := new(CodeRequest)
	err := c.cc.Invoke(ctx, "/helloworld.HelloworldService/EnviarDatos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloworldServiceServer interface {
	...
	EnviarDatos(context.Context, *PaqueteRequest) (*CodeRequest, error)
}
...
func (*UnimplementedHelloworldServiceServer) EnviarDatos(context.Context, *PaqueteRequest) (*CodeRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnviarDatos not implemented")
}
...
func _HelloworldService_EnviarDatos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PaqueteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloworldServiceServer).EnviarDatos(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.HelloworldService/EnviarDatos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloworldServiceServer).EnviarDatos(ctx, req.(*PaqueteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _HelloworldService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HelloworldService_EnviarDatos_Handler,
		},
	},
